...
//    reference(2)          = -2;
    ...
    double weight = 2800;
    double buoyancy = 2818;

    rg(0) = 0;  rg(1) = 0;  rg(2) = 0;
    rb(0) = 0.0;  rb(1) = 0;  rb(2) = 0.08;

    M(0, 0) = 851.05;  M(1, 1) = 1170;  M(2, 2) = 1521.45;
    M(3, 3) = 35;   M(4, 4) = 35;   M(5, 5) = 317.21;
    Dl(0, 0) = 39.57;  Dl(1, 1) = 35.5;  Dl(2, 2) = 31.40;
    Dl(3, 3) = 45;  Dl(4, 4) = 45;  Dl(5, 5) = 1.75;
    Dq(0, 0) = 8.62;  Dq(1, 1) = 5;  Dq(2, 2) = 2.24;
    Dq(3, 3) = 35;  Dq(4, 4) = 35;  Dq(5, 5) = 334.41;
